...
//    var userResult = (await _fireAuth.signInWithEmailAndPassword(email: user.email, password: user.password)).user;
...
//
//  @override
//  Future<String> signUp(String name, String contact, String email, String password) async {
//    // TODO: implement signUp
//    var user = (await _fireAuth.createUserWithEmailAndPassword(email: email, password: password)).user;
//    return user.uid;
//  }
//
//  @override
